...
public class Main {
	...
	public static void main(String[] args) {
		...
		campers1.add(new Camper("циаммгс хеойкгс", "6982233611", "кацйадас", 10, "кеыжыяио",false, "йамема", "йамема") ); 
		...
		leaders2.add(new Teamleader("келомиа мтоуйг", "6982233611", "м.апоккомиа", 20, "кеыжыяио",false, "йамема", "йамема", 2)) ;
		campers2.add(new Camper("еиягмг моялоу", "6982233611", "кацйадас", 10, "кеыжыяио",false, "йамема", "йамема") ); 
		campers2.add(new Camper("еуцемеиа мтотсг", "6982233611", "кацйадас", 10, "аутойимгто",false, "йамема", "йамема") ); 
		campers2.add(new Camper("ваяийкеиа кеутеяоу", "6982233611", "лийяг бокбг", 10, "кеыжыяио",false, "йамема", "йамема") ); 
		campers2.add(new Camper("ахгма мамама", "6982233611", "лецакг бокбг", 10, "аутойимгто",false, "йамема", "йамема") ); 
		campers2.add(new Camper("екпида цеяасилиоу", "6982233611", "вакастяа", 10, "аутойимгто",false, "йамема", "йамема") ); 
